...
export default function Navbar ({username}) {
    ...
    return (
        <>
            ...
            flex-row justify-between h-[54px] lg:px-[60px] sm:h-[96px] items-center w-[100%]">
                ...
                className='flex cursor-pointer flex-row justify-center items-center'>
                    ...
                    { showDropdown && 
                    <div className="bg-white text-[14px] darkest-col absolute ml-[76%] float-right mt-[9rem] rounded-md flex 
                    flex-col w-[200px] h-[90px]">
                        <Link 
                        href={'/profile'}
